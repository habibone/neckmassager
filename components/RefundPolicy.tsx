  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
      ...
      <div className="relative bg-white w-full max-w-2xl max-h-[85vh] rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in duration-300">
        ...
        {/* Body */}
        <div className="flex-1 overflow-y-auto p-8 space-y-6 text-[#848693] text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-gray-900 font-black uppercase text-sm tracking-widest flex items-center">
              <span className="w-6 h-6 bg-[#6149dd]/10 text-[#6149dd] rounded-md flex items-center justify-center text-[10px] mr-3 font-black">1</span>
          ...
          <section className="space-y-3">
            <h3 className="text-gray-900 font-black uppercase text-sm tracking-widest flex items-center">
              <span className="w-6 h-6 bg-[#6149dd]/10 text-[#6149dd] rounded-md flex items-center justify-center text-[10px] mr-3 font-black">2</span>
            ...
            <div className="pl-9 space-y-2">
              ...
              <p className="bg-gray-50 p-4 rounded-xl italic border-l-4 border-[#6149dd] text-[12px]">
          ...
          <section className="space-y-3">
            <h3 className="text-gray-900 font-black uppercase text-sm tracking-widest flex items-center">
              <span className="w-6 h-6 bg-[#6149dd]/10 text-[#6149dd] rounded-md flex items-center justify-center text-[10px] mr-3 font-black">3</span>
              Replacement Options
            </h3>
            <div className="pl-9 space-y-4">
              <div>
          ...
          <section className="space-y-3 pt-4 border-t border-gray-100">
            <h3 className="text-gray-900 font-black uppercase text-sm tracking-widest flex items-center">
              <span className="w-6 h-6 bg-[#6149dd]/10 text-[#6149dd] rounded-md flex items-center justify-center text-[10px] mr-3 font-black">4</span>
              Refund Policy
            </h3>
            <div className="pl-9">
              <p className="font-black text-[#6149dd] uppercase">Please note that Wave Byte does not offer refunds under any circumstances. Only valid replacement claims will be processed in accordance with this policy.</p>
            </div>
          </section>
          ...
          <section className="space-y-3 pt-4 border-t border-gray-100">
            ...
            <div className="pl-0 space-y-2">
              ...
              <div className="bg-[#6149dd]/5 p-6 rounded-2xl space-y-2 border border-[#6149dd]/10">
                <p className="font-bold text-gray-900">WhatsApp: <a href="https://wa.me/971507518901" className="text-[#6149dd]">+971 50 751 8901</a></p>
                <p className="font-bold text-gray-900">Warehouse Address: <br/><span className="font-medium text-[#848693]">Warehouse No. 13, Street No. 4 – 4th Street, Al Khabaisi, Dubai, UAE</span></p>
              </div>
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-100 text-center">
          <button 
            onClick={onClose}
            className="px-8 py-3 gradient-cta text-white font-black rounded-xl uppercase text-xs tracking-widest shadow-lg shadow-[#6149dd]/10"
          >
            I Understand
          </button>
        </div>
