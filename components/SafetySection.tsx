    ...
    <section className="py-20 px-6 bg-white border-t border-gray-50">
      <div className="max-w-4xl mx-auto bg-gray-50 rounded-[3rem] p-8 md:p-12 border border-gray-100 shadow-sm">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="w-24 h-24 flex-shrink-0 bg-orange-100 rounded-3xl flex items-center justify-center">
          ...
          <div className="space-y-4 text-center md:text-left flex-1">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3 text-gray-700">
                ...
                <span className="text-sm font-bold uppercase">Silent 400W Motor</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-700">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-sm font-bold uppercase">Overheat Protection</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-700">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-sm font-bold uppercase">Power Safety Logic</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-700">
                <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                <span className="text-sm font-bold uppercase">Home-Friendly Use</span>
              </div>
            </div>
