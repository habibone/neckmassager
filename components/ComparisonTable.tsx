      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black text-[#111827] mb-4 uppercase tracking-tighter">
            The VibeSlim <span className="text-[#6149dd]">Difference</span>
          </h2>
          <p className="text-[#848693] text-lg font-medium">Why we are the leading choice for home fitness in the UAE.</p>
        </div>

        <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100">
          <div className="grid grid-cols-2 text-center">
            <div className="p-6 bg-[#6149dd] text-white">
              <p className="text-sm md:text-lg font-black uppercase tracking-widest">Weight Loss Vibration Machine</p>
            </div>
            <div className="p-6 bg-gray-100 text-[#848693] border-l border-white/20">
              <p className="text-sm md:text-lg font-black uppercase tracking-widest">Generic Brands</p>
            </div>

            {COMPARISON_DATA.us.map((item, idx) => (
              <React.Fragment key={idx}>
                <div className="p-4 md:p-6 border-b border-gray-50 flex items-center justify-center space-x-2 bg-[#6149dd]/5">
                ...
                <div className="p-4 md:p-6 border-b border-gray-50 flex items-center justify-center space-x-2">
                  ...
                  <span className="text-[#848693] text-[10px] md:text-sm line-through font-medium">{COMPARISON_DATA.them[idx]}</span>
                </div>
              </React.Fragment>
            ))}
          </div>
